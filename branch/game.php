	...
	<div id="wrap" class="clear">
		...
		<div id="content" class="clear">
			<div id="loading_screen" class="hidden">
				<div id="login" class="hidden"> 
					...
					<a title="Logi sisse Facebooki kaudu"><img alt="Facebook login" src="img/button-facebook-login.gif"></a></p>
				</div> <!--#login end-->
				<div id="account" class="hidden"> 
					<p>Vali konto:</p>
					<p><a title="Twitter"><img alt="Twitter" height="64" width="64" src="img/Twitter.png"></a> 
					<a title="Facebook"><img alt="Facebook" height="64" width="64" src="img/Facebook.png"></a></p>
				</div><!--#account end-->
				...
				<ol id="win" class="hidden">
					...
					<li id="prize"><img height="100" width="100" src="img/karikas.png" alt="prize"></li>
					<li>
						<img src="http://placekitten.com/48/48">
						<p class="name">name</p>
					</li>
			...
			<div id="game_data" class="clear">
				<div id="game">
					<div id="game_holder" class="clear">
						...
						<li id="top_middle">&nbsp;</li>
						<li>&nbsp;</li>
						<li id="left_middle"><img height="100" width="106" src="img/x1.gif" alt="x"></li>
						<li id="middle"><img src="img/o3.gif" alt="0"></li>
				...
				<dl id="p1" class="clear">
					<dt class="move"><img alt="arrow" src="img/nool.png"></dt>
					<dd class="role">X</dd>
		...
		<div id="footer">
			<ul id="info">
				...
				<li><a  rel="next" href="" title="Trips-traps-trull Twitteris"><img alt="Twitter logo" height="16" width="16" src="img/tw.jpeg"></a></li>
				<li><a  rel="next" href="" title="Trips-traps-trull Facebookis"><img alt="Facebook logo" height="16" width="16" src="img/fb.jpeg"></a></li>
			</ul><!--#info end-->
		</div><!--#footer end-->
	</div><!--#wrap end-->
</body>
